...
<html>
   				...
   				$.ajax({
   					...
   					success:function(data){
   						...
   						for(var i=0;i<data.length;i++){
   							$("#s2").append("<option value="+data[i].uid+">"+data[i].realname+"</option>");
   						}
   					}
   				});
   			});
 ...
 <body>
  ...
  <div class="container">
    <form action="${initParam.p }/homework_save" id ="J_Form" class="form-horizontal">
      <!--    -->
      <h3>添加作业信息</h3>
      <div class="row">
        ...
        <div class="control-group span12">
          ...
          <div class="controls">
          	<select  name="user.uid" id="s2">	
          	</select>
          </div>
        </div>
        <div class="control-group span12">
          <label class="control-label"><s>*</s>完成情况：</label>
          <div class="controls">
