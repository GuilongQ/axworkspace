    ...
    <form action="${initParam.p }/user_save" id ="J_Form" class="form-horizontal">
      	...
      	<div class="control-group span20">
      		 ...
      		 <div class="controls">
      		 	<c:forEach items="${roleList }" var="r">
      		 		<label>
      		 			<input type="radio" name="rid" value="${r.rid }" /><span>${r.rname }</span>
      		 		</label>
      		 	</c:forEach>
	         </div>
      	</div>
      ...
      <div class="row">
        ...
        <div class="control-group span8">
          ...
          <div class="controls">
            <input name="username" type="text" class="control-text" data-rules="{required:true}" />
          </div>
        </div>
        <div class="control-group span8">
          <label class="control-label"><s>*</s>密码：</label>
          <div class="controls">
            <input name="password" type="text" class="control-text" data-rules="{required:true}" />
          </div>
        </div>
        <div class="control-group span8">
        ...
        <div class="control-group span8">
          ...
          <div class="controls">
            <input readonly="readonly" name="birthday" type="text" class="control-text" data-rules="{required:true}" />
          </div>
        </div>
        <div class="control-group span8">
          <label class="control-label"><s>*</s>手机：</label>
          <div class="controls">
            <input name="cellphone"  type="text" class="control-text" data-rules="{required:true}" />
          </div>
        </div>
        <div class="control-group span8">
        ...
        <div class="control-group span8">
          ...
          <div class="controls">
            <input  name="email" type="text" class="control-text" data-rules="{required:true}" />
          </div>
        </div>
        <div class="control-group span8">
        ...
        <div class="control-group span8">
          ...
          <div class="controls">
            <input name="sal" type="text" class="control-text" data-rules="{required:true}" />
          </div>
        </div>
      </div>
      <hr/>
      ...
      <div class="row">
        <div class="form-actions offset3">
          <button id="savebtn" type="submit" class="button button-primary">保存</button>
