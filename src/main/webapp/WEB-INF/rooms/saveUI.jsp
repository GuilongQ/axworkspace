...
<html>
 ...
 <body>
  ...
  <div class="container">
    <form action="${initParam.p }/room_save" id ="J_Form" class="form-horizontal">
      <!--    -->
      <h3>添加房间信息</h3>
      <div class="row">
        <div class="control-group span12">
          ...
          <div class="controls">
            <input name="position" type="text" class="control-text" data-rules="{required:true}">
          </div>
        </div>
        <div class="control-group span12">
          <label class="control-label"><s>*</s>房间租金：</label>
          <div class="controls">
            <input name="rent" type="text" class="control-text" data-rules="{required:true}"/>
          </div>
        </div>
      </div>
      <hr/>
