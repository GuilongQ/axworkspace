...
<html>
 ...
 <body>
  ...
  <div class="container">
    <form action="${initParam.p }/room_update" id ="J_Form" class="form-horizontal">
    	<input type="hidden" name="roomid" value="${t.roomid }">
      <!--    -->
      <h3>修改房间信息</h3>
      <div class="row">
        <div class="control-group span12">
          <label class="control-label"><s>*</s>房间位置：</label>
          <div class="controls">
            <input value="${t.position }" name="position" type="text" class="control-text" data-rules="{required:true}">
          </div>
        </div>
        <div class="control-group span12">
          <label class="control-label"><s>*</s>房间租金：</label>
          <div class="controls">
            <textarea name="rent"  type="text" class="control-text" data-rules="{required:true}">${t.rent }</textarea>
          </div>
        </div>
      </div>
      <hr/>
