...
<html>
 ...
 <body>
  ...
  <div class="container">
    <form action="${initParam.p }/course_update" id ="J_Form" class="form-horizontal">
      ...
      <div class="row">
        <div class="control-group span12">
          ...
          <div class="controls">
            <input value="${t.cname }" name="cname" type="text" class="control-text" data-rules="{required:true}">
          </div>
        </div>
        <div class="control-group span12">
          <label class="control-label"><s>*</s>课程描述：</label>
          <div class="controls">
            <textarea name="info" style="width:300px; height:30px"  type="text" class="control-text" data-rules="{required:true}">${t.info }</textarea>
          </div>
        </div>
      </div>
      <hr/>
