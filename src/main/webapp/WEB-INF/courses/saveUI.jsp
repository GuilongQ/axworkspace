...
<html>
 ...
 <body>
  ...
  <div class="container">
    <form action="${initParam.p }/course_save" id ="J_Form" class="form-horizontal">
      <!--    -->
      <h3>添加课程信息</h3>
      <div class="row">
        <div class="control-group span12">
          ...
          <div class="controls">
            <input name="cname" type="text" class="control-text" data-rules="{required:true}">
          </div>
        </div>
        <div class="control-group span12">
          <label class="control-label"><s>*</s>课程描述：</label>
          <div class="controls">
            <input name="info" style="width:300px; height:30px" type="text" class="control-text" data-rules="{required:true}"/>
          </div>
        </div>
      </div>
      <hr/>
